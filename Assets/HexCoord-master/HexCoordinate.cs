...
namespace Settworks.Hexagons {
	...
	/// <remarks><see cref="Settworks.Hexagons.HexCoord"/> is a struct for performance reasons, 
    /// but Unity before v4.5.0 did not support serialization of structs. 
    /// This serializable class is easily converted to and from <see cref="Settworks.Hexagons.HexCoord"/>, 
    /// allowing it to be used in places where serialization is needed without affecting the performance of other logic.</remarks>
	[Serializable]
